  ...
  return (
    <>
      {Array.from({ length: 5 }).map((_, index) => (
        <div
          key={index}
          className="relative flex flex-col gap-5 rounded-lg bg-zinc-900 px-6 pb-4 pt-12 text-white"
        >
          ...
          <Typography as="body3">Canada eSIM Plans</Typography>
          ...
          <div className="divide-y divide-zinc-700">
            <div className="flex items-center gap-3 py-4">
              ...
              <Typography as="body5" className="flex-1 text-zinc-500">
                Coverage
              </Typography>
              <Typography as="body5" className="font-medium text-zinc-100">
                Japan
              </Typography>
            </div>
