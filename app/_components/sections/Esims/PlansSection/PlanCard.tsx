    ...
    <>
      {esimPlans
        ...
        .map((esimPlan) => (
          <div
            key={esimPlan.id}
            className="relative z-10 flex flex-col gap-5 rounded-lg bg-blue-600/80 px-6 pb-4 pt-12 text-white"
          >
            ...
            <div className="divide-y-[.5px] divide-zinc-50">
              <div className="flex items-center gap-3 py-4">
                ...
                <Typography as="body5" className="flex-1 text-zinc-50">
                  Coverage
                </Typography>
            ...
            <Link
              className={cn(
                ...
                "w-full text-center outline-white hover:bg-blue-500"
              )}
