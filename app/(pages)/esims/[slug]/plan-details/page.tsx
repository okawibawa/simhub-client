  ...
  return (
    <main className="full-width h-full bg-black py-5">
      ...
      <div className="grid grid-cols-1 gap-2 lg:grid-cols-3">
        <div className="space-y-4 rounded-xl bg-zinc-900 px-4 py-5 lg:col-span-2">
          <div>
          ...
          <div>
            ...
            <Typography as="body5" className="text-zinc-50">
              - Ensure you have an available internet connection, either through
              Wi-Fi or your physical SIM card.
            </Typography>
            <Typography as="body5" className="text-zinc-50">
          ...
          <div>
            ...
            <Typography as="body5" className="text-zinc-50">
              - The check-in (purchase confirmation) period is 180 days from the
              date of product purchase, and you can apply for a refund during
              this period.
            </Typography>
            <Typography as="body5" className="text-zinc-50">
